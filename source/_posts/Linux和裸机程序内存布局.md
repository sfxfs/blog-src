...
- [Linux 进程虚拟地址空间](#linux)
  - [进程虚拟地址空间的主要分区](#进程虚拟地址空间的主要分区)
  - [内存排布和地址增长方向](#内存排布和地址增长方向)
  - [按需分页](#按需分页)
- [裸机（STM32）内存布局](#裸机stm32)
  - [STM32 微控制器的内存布局](#stm32-微控制器的内存布局)
  - [与 PC 内存模型的关键区别](#与-pc-内存模型的关键区别)
